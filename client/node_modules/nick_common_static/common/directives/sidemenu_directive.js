...
define(["require", "exports"], function (require, exports) {
    ...
    var mdSideMenuSections = (function () {
        ...
        return mdSideMenuSections;
    }());
    mdSideMenuSections._name = "mdSideMenuSections";
    mdSideMenuSections.provider = [function () {
    ...
    exports.mdSideMenuSections = mdSideMenuSections;
    var mdStyleDirective = (function () {
        function mdStyleDirective() {
        }
        return mdStyleDirective;
    }());
    mdStyleDirective._name = 'mdStyleColor';
    mdStyleDirective.directive = ['$rootScope', mdSideMenuSections._name, function ($rootScope, mdSideMenuSections) {
            var directive = {
                restrict: 'A',
                scope: {
                    mdStyleColor: '='
                        ...
                        for (var p in $scope.mdStyleColor) {
                            if ($scope.mdStyleColor.hasOwnProperty(p)) {
                                ...
                                if ($element.parent().attr('md-component-id'))
                                    $element.parent().css(p, 'rgb(' + colorValue.join(',') + ')');
                            }
                        }
                    };
    ...
    exports.mdStyleDirective = mdStyleDirective;
    var mdSideMenuFactory = (function () {
        function mdSideMenuFactory() {
        }
        return mdSideMenuFactory;
    }());
    mdSideMenuFactory._name = 'mdSideMenuFactory';
    mdSideMenuFactory.factory = ['$rootScope', mdSideMenuSections._name, function ($rootScope, mdSideMenuSections) {
    ...
    exports.mdSideMenuFactory = mdSideMenuFactory;
    ...
    SideMenuDirective.directive = ['$rootScope', '$compile', mdSideMenuSections._name, function ($rootScope, $compile, mdSideMenuSections) {
            var directive = {
                restrict: 'EA',
                replace: false,
                require: 'sideMenu',
                ...
                controller: ['$scope', '$templateCache', '$interpolate', mdSideMenuFactory._name, function ($scope, $templateCache, $interpolate) {
                        ...
                        $templateCache.put("js/partials/directives/sidemenu.html", "<ul ng-if=\"node.{{opts.children}}.length\">\n" +
