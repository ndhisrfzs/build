...
export class PutongService {
    ...
    public static factory:Array<any> = ['$rootScope', '$q', '$http', 'config', ($rootScope, $q, $http, config):any=> {
        return {
            ...
            add_a_question: (model:Brave.QuestionModel)=> {
                return $http({
                    method: 'POST',
                    url: config.putong_api_url + '/odw/add_a_question',
                    data: {
                        title: model.title,
                        question: model.question,
                        background_url: model.backgroundUrl,
                        tower: model.tower,
                        chapter_num: model.chapter,
                        stage_num: model.stage,
