...
angular.module("client/js/partials/controllers/common/chart.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("client/js/partials/controllers/common/chart.html",
    ...
    "        <canvas id=\"line\" class=\"chart chart-line\" chart-data=\"managerCtl.data\"\n" +
    "        chart-labels=\"managerCtl.labels\" chart-series=\"managerCtl.series\" chart-options=\"managerCtl.options\"\n" +
    "        chart-dataset-override=\"managerCtl.datasetOverride\" chart-click=\"managerCtl.onClick\">\n" +
    "        </canvas>\n" +
    "    </md-content>\n" +
...
angular.module("client/js/partials/controllers/common/manager.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("client/js/partials/controllers/common/manager.html",
    ...
    "                                  ng-if=\"managerCtl.itemToolbars.length\"\n" +
...
angular.module("client/js/partials/controllers/common/page_form.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("client/js/partials/controllers/common/page_form.html",
    "<!--表格数据-->\n" +
    "<md-content layout=\"row\" flex>\n" +
    "    <md-content flex layout=\"column\" md-theme=\"dark\">\n" +
    "        <ng-include src=\"'js/partials/controllers/common/toolbar.html'\"></ng-include>\n" +
    ...
    "            <div layout=\"column\" offset-gt-md=\"40\" offset-gt-sm=\"35\" flex-gt-sm=\"30\" flex-gt-md=\"20\" flex-sm=\"90\" offset-sm=\"5\">\n" +
    "                <form name=\"recharge_form\"\n" +
    "                    sf-model=\"managerCtl.searchData\"\n" +
    "                    sf-form=\"managerCtl.searchForm\"\n" +
    "                    sf-schema=\"managerCtl.schema\"\n" +
    "                    ng-submit=\"managerCtl.submit(recharge_form)\"></form>\n" +
    "            </div>\n" +
    "        </div>\n" +
    "    </md-content>\n" +
    "</md-content>");
