 ...
 * copyright NICK
 */
define(["require", "exports", "settings/routers/default", "settings/routers/home", "settings/routers/login", "settings/routers/pages", "settings/roles/anonymous", "settings/roles/user", "settings/themes/blue", "settings/themes/dark", "settings/themes/white_cyan", "settings/themes/amazing"], function (require, exports, defaultRouter, homeRouter, loginRouter, pageRouter, anonymousUser, userUser, defaultTheme, darkTheme, whiteCyanTheme, amazingTheme) {
    "use strict";
