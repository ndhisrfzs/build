            ...
            link: function ($scope, element, attrs, ngModel) {
                        ...
                        change: function () {
                            ...
                            debounceTo = $timeout(function () {
                                if (editor) {
                                    ...
                                    ngModel.$setViewValue(($scope.preferText === true || $scope.preferText === "true") ? editor.getText() : editor.get());
                ...
                $scope.updateJsonEditor = function (newValue) {
                    ...
                    debounceFrom = $timeout(function () {
                        if (($scope.preferText === true || $scope.preferText === "true") && !angular.isObject(ngModel.$viewValue)) {
                ...
                if ($scope.options.hasOwnProperty('expanded')) {
                    $timeout($scope.options.expanded ? function () {
                        editor.expandAll();
                    } : function () {
                        editor.collapseAll();
