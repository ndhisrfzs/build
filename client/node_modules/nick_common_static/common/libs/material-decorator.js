define(['angular', 'schemaForm'], function (angular) {
    angular.module("schemaForm").run(["$templateCache", function($templateCache) {$templateCache.put("decorators/material/actions-trcl.html","<div class=\"btn-group schema-form-actions {{form.htmlClass}}\" ng-transclude=\"\"></div>");
        ...
        $templateCache.put("decorators/material/array.html","<div class=\"schema-form-{{form.type}} {{form.htmlClass}}\" md-theme=\"dark\" id=\"{{::form.key}}\" name=\"{{::form.key}}\" sf-field-model=\"replaceAll\" sf-new-array=\"$$value$$\"><div layout=\"row\" style=\"padding: 0;\" class=\"md-toolbar-tools\"><label class=\"control-label\" flex=\"\" ng-show=\"showTitle()\">{{ form.title }}</label><md-button class=\"md-icon-button\" aria-label=\"add\" ng-if=\"!modelArray || modelArray.length==0\" ng-hide=\"form.readonly || form.add === null\" ng-click=\"appendToArray()\" ng-disabled=\"form.schema.maxItems <= modelArray.length\"><ng-md-icon icon=\"add\"></ng-md-icon></md-button></div><md-list class=\"list-group\" ng-model=\"modelArray\" ui-sortable=\"form.sortOptions\"><md-content layout=\"row\" layout-padding=\"\" class=\"list-group-item md-secondary md-whiteframe-3dp\" ng-repeat=\"item in modelArray track by $index\"><md-content flex=\"\" schema-form-array-items=\"\" class=\"{{form.fieldHtmlClass}}\"><label>{{ form.title + ($index+1) }}</label></md-content><md-content layout=\"column\" flex=\"none\" flex-order=\"2\"><md-button class=\"md-icon-button\" aria-label=\"remove\" ng-hide=\"form.readonly || form.remove === null\" ng-click=\"deleteFromArray($index)\" ng-disabled=\"form.schema.minItems >= modelArray.length\"><ng-md-icon icon=\"delete\"></ng-md-icon></md-button><md-button class=\"md-icon-button\" aria-label=\"add\" ng-hide=\"form.readonly || form.add === null\" ng-click=\"appendToArray()\" ng-disabled=\"form.schema.maxItems <= modelArray.length\"><ng-md-icon icon=\"add\"></ng-md-icon></md-button></md-content></md-content></md-list><md-input-container style=\"padding: 0;\"><div ng-messages=\"ngModel.$error\"><div sf-message=\"\" ng-message=\"\"></div></div></md-input-container></div>");
        ...
        $templateCache.put("decorators/material/checkbox.html","<div class=\"checkbox schema-form-checkbox {{form.htmlClass}}\"><md-checkbox sf-field-model=\"\" ng-show=\"form.key\" type=\"{{form.type}}\" aria-label=\"{{ form.title }}\" step=\"any\" ng-model=\"$$value$$\" sf-changed=\"form\" id=\"{{form.key.slice(-1)[0]}}\" ng-model-options=\"form.ngModelOptions\" ng-class=\"form.fieldHtmlClass\" ng-disabled=\"form.readonly\" name=\"{{form.key.slice(-1)[0]}}\" schema-validate=\"form\"><span ng-bind-html=\"form.title\"></span></md-checkbox><div ng-messages=\"ngModel.$error\"><div sf-message=\"\" ng-message=\"\"></div></div></div>");
        ...
        $templateCache.put("decorators/material/switch.html","<md-input-container class=\"schema-form-switch {{::form.htmlClass}}\"><md-switch ng-click=\"form.click()\"  sf-field-model=\"\" sf-changed=\"form\" sf-type-parser=\"form.schema\" sf-messages=\"\" schema-validate=\"form\" id=\"{{::form.key}}\" aria-label=\"{{form.title}}\" class=\"md-secondary\" ng-show=\"::form.key\" ng-class=\"form.fieldHtmlClass\" ng-disabled=\"::form.readonly\"><span ng-show=\"showTitle()\" for=\"{{::form.key}\">{{::form.title}}</span></md-switch></md-input-container>");
        ...
        $templateCache.put("decorators/material/textarea.html","<md-input-container ng-class=\"form.htmlClass\" class=\"schema-form-textarea\" aria-label=\"{{ form.title }}\"><label ng-show=\"showTitle()\">{{form.title}}</label> <textarea ng-class=\"form.fieldHtmlClass\" ng-model=\"$$value$$\" id=\"{{form.key.slice(-1)[0]}}\" sf-changed=\"form\" ng-disabled=\"form.readonly\" sf-field-model=\"\" schema-validate=\"form\" rows=\"{{ form.rows }}\" cols=\"{{ form.cols }}\" md-maxlength=\"{{form.maxlength}}\" name=\"{{form.key.slice(-1)[0]}}\">\n\n  </textarea><div ng-messages=\"ngModel.$error\"><div sf-message=\"\" ng-message=\"\"></div></div></md-input-container>");
