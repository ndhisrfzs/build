...
define(["require", "exports", 'common/models/common/base_data', 'common/models/passport/user_model'], function (require, exports, cd, um) {
    ...
    (function (Dashboard) {
        ...
        var BasModel = (function (_super) {
            ...
            BasModel._convert = function (data) {
                return new Dashboard.BasModel({
                    baId: data.id,
                    avatarUrl: data.ba_avatar_url,
                    ...
                    bazhus: data.bazhus ? data.bazhus.map(function (bazhu) {
                        return new um.Passport.UserModel({
                            nickname: bazhu.nickname,
                            avatarUrl: bazhu.avatar_url,
                            userToken: bazhu.user_token
                        });
                    }) : []
                });
            };
