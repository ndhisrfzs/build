...
angular.module("client/js/partials/controllers/common/chart.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("client/js/partials/controllers/common/chart.html",
    "<md-content layout=\"row\" flex>\n" +
    "    <md-content flex layout=\"column\" md-theme=\"dark\">\n" +
    "        <ng-include src=\"'js/partials/controllers/common/chart_toolbar.html'\"></ng-include>\n" +
    "        <canvas id=\"line\" class=\"chart chart-line\" chart-data=\"chartCtl.data\"\n" +
    "        chart-labels=\"chartCtl.labels\" chart-series=\"chartCtl.series\" chart-options=\"chartCtl.options\"\n" +
    "        chart-dataset-override=\"chartCtl.datasetOverride\" chart-click=\"chartCtl.onClick\">\n" +
    "        </canvas>\n" +
    "    </md-content>\n" +
    "    <ng-include class=\"md-whiteframe-z2 am-fade-and-slide-right\" ng-show=\"chartCtl.searchMode\" layout=\"column\"\n" +
    "                flex-gt-sm=\"30\"\n" +
    "                flex=\"100\"\n" +
    "                src=\"'js/partials/controllers/common/chart_search.html'\"></ng-include>\n" +
    "</md-content>");
}]);

angular.module("client/js/partials/controllers/common/chart_search.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("client/js/partials/controllers/common/chart_search.html",
    ...
    "                       class=\"md-icon-button md-ink-ripple\"\n" +
    "                       ng-click=\"chartCtl.getServerData()\">\n" +
    "                <md-tooltip>\n" +
    "                    刷新\n" +
    "                </md-tooltip>\n" +
    ...
    "                       class=\"md-icon-button md-ink-ripple\"\n" +
    "                       ng-click=\"chartCtl.toggleSearchBar()\">\n" +
    "                <md-tooltip>\n" +
    "                    关闭\n" +
    "                </md-tooltip>\n" +
    ...
    "              layout=\"column\"\n" +
    "              flex\n" +
    "              sf-schema=\"chartCtl.schema\"\n" +
    "              sf-form=\"chartCtl.searchForm\"\n" +
    "              sf-model=\"chartCtl.searchData\">\n" +
    "        </form>\n" +
    "    </md-content>\n" +
    "    <md-divider></md-divider>\n" +
    "    <md-button ng-disabled=\"chartCtl.isBusy\"\n" +
    "               aria-label=\"search\"\n" +
    "               ng-click=\"chartCtl.doSearch(searchForm)\">\n" +
    "        过滤一下\n" +
    "    </md-button>\n" +
    "\n" +
    "</md-content>\n" +
...
angular.module("client/js/partials/controllers/common/chart_toolbar.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("client/js/partials/controllers/common/chart_toolbar.html",
    "<md-data-table-toolbar ng-hide=\"selected.length || filter.show\" aria-hidden=\"false\">\n" +
    "    <ng-md-icon ng-if=\"chartCtl.icon\" icon=\"{{chartCtl.icon}}\"></ng-md-icon>\n" +
    "    <h2 class=\"md-title\">{{ chartCtl.title }}</h2>\n" +
    "    <div flex=\"\"></div>\n" +
    "    <div class=\"md-toolbar-item\" layout=\"row\">\n" +
    "        <md-button ng-repeat=\"item in $root.toolbars\"\n" +
    "                   ng-click=\"item.onClick($event)\"\n" +
    "                   ng-disabled=\"chartCtl.isBusy\"\n" +
