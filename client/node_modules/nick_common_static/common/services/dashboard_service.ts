...
export class DashboardService {
    ...
    public static factory:Array<any> = ['$rootScope', '$q', '$http', 'config', ($rootScope, $q, $http, config):any=> {
        return {
            ...
            list_goddess_questions: (query:Brave.QuestionListQuery)=> {
                var promise = $http({
                    method: 'GET',
                    url: config.dashboard_api_url + '/odw_admin/list_goddess_questions',
                    params: {
                        page: query.page,
                        per_page: query.pageCount,
                        series: query.series
            ...
            list_chapters: (query:Brave.ChapterListQuery)=> {
                var promise = $http({
                    method: 'GET',
                    url: config.dashboard_api_url + '/odw_admin/list_chapters',
                    params: {
                        page: query.page,
                        per_page: query.pageCount,
                        tower: query.tower
            ...
            list_questions: (query:Brave.QuestionListQuery)=> {
                var promise = $http({
                    method: 'GET',
                    url: config.dashboard_api_url + '/odw_admin/list_questions',
                    params: {
                        page: query.page,
                        per_page: query.pageCount,
                        chapter_num: query.chapter
                    },
                    needToken: true,
                }).success(function (data) {
            ...
            list_stages: (query:Brave.StageListQuery)=> {
                var promise = $http({
                    method: 'GET',
                    url: config.dashboard_api_url + '/odw_admin/list_stages',
                    params: {
                        page: query.page,
                        per_page: query.pageCount,
                        chapter_num: query.chapter,
            ...
            add_a_goddess_question: (data:Brave.QuestionModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/add_a_goddess_question',
                    data: {
            ...
            del_a_goddess_question: (data:Brave.QuestionModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/del_a_goddess_question',
                    data: {
                        goddess_question_id: data.id
                    },
                    needToken: true,
                }).success(function (data) {
            ...
            on_goddess_questions: (data:Array<number>)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/on_goddess_questions',
                    data: {
                        goddess_question_ids_str: data.join(',')
                    },
                    needToken: true,
                }).success(function (data) {
            ...
            off_goddess_questions: (data:Array<number>)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/off_goddess_questions',
                    data: {
                        goddess_question_ids_str: data.join(',')
                    },
                    needToken: true,
            ...
            add_a_chapter: (data:Brave.ChapterModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/add_a_chapter',
                    data: {
                        tower: data.tower,
                        num: data.num,
                        stages_count: data.stageCount,
                        title: data.title,
                        description: data.description,
                        background_url: data.backgroundUrl,
                        alive_background_url: data.aliveBackgroundUrl,
                        dead_background_url: data.deadBackgroundUrl,
                        select_background_url: data.selectBackgroundUrl,
                        alive_words: data.aliveWords,
                        dead_words: data.deadWords
                    },
                    needToken: true,
                }).success(function (data) {
            ...
            update_a_chapter: (data:Brave.ChapterModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/update_a_chapter',
                    data: {
                        chapter_id: data.id,
                        tower: data.tower,
                        num: data.num,
            ...
            del_a_chapter: (data:Brave.ChapterModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/del_a_chapter',
                    data: {
                        chapter_id: data.id
                    },
                    needToken: true,
            ...
            on_chapters: (data:Array<number>)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/on_chapters',
                    data: {
                        chapter_ids_str: data.join(',')
                    },
                    needToken: true,
                }).success(function (data) {
            ...
            off_chapters: (data:Array<number>)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/off_chapters',
                    data: {
                        chapter_ids_str: data.join(',')
                    },
                    needToken: true,
            ...
            add_a_question: (data:Brave.QuestionModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/add_a_question',
                    data: {
                        title: data.title,
                        question: data.question,
                        background_url: data.backgroundUrl,
            ...
            del_a_question: (data:Brave.QuestionModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/del_a_question',
                    data: {
                        question_id: data.id
                    },
                    needToken: true,
            ...
            update_a_question: (data:Brave.QuestionModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/update_a_question',
                    data: {
                        question_id: data.id,
                        title: data.title,
                        question: data.question,
            ...
            on_questions: (data:Brave.QuestionOnModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/on_questions',
                    data: {
                        question_ids_str: data.questions.join(','),
                        tower: data.tower,
                        chapter_num: data.chapter,
                        stage_num: data.stage
                    },
            ...
            off_questions: (data:Array<number>)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/off_questions',
                    data: {
                        question_ids_str: data.join(',')
                    },
                    needToken: true,
                }).success(function (data) {
            ...
            update_a_stage: (data:Brave.StageModel)=> {
                var promise = $http({
                    method: 'POST',
                    url: config.dashboard_api_url + '/odw_admin/update_a_stage',
                    data: {
                        stage_id: data.id,
                        tower: data.tower,
                        chapter_num: data.chapter,
                        num: data.stage,
                        question_ids_str: data.question_ids
                    },
                    needToken: true,
                }).success(function (data) {
