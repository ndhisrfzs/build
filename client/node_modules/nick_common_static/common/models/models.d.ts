...
declare module Brave {
    ...
    interface QuestionOnModel extends Common.BaseData {
    ...
    interface ChapterModel extends Common.BaseData {
        id:number;
        tower:string;
        num:number;
        stageCount:number;
        ...
        description:string;
        backgroundUrl:string;
        selectBackgroundUrl:string;
        aliveBackgroundUrl:string;
        deadBackgroundUrl:string;
        status:number;
        creator:Passport.UserModel;
        aliveWords:string;
        deadWords:string;
    ...
    interface QuestionModel extends Common.BaseData {
        id:number;
        title:string;
        question:string;
        backgroundUrl:string;
    ...
    interface ChapterListQuery extends Common.QueryBase {
        tower:string;
    }

    interface QuestionListQuery extends Common.QueryBase {
        series:string;
        chapter:number;
    }

    interface  StageListQuery extends Common.QueryBase {
        series:string;
        chapter:number;
        tower:string;
    }

    interface StageModel extends Common.BaseData {
        questions:Array<number>;
        id:number;
        question_ids:string;
        tower:string;
