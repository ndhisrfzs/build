...
import gpcadd = require('controllers/permission/schemas/manager_add_controller');
import gpcedit= require('controllers/permission/schemas/manager_edit_controller');

export class Controller extends gridCon.GridController<any> {
    public static _name:string = 'SchemaManagerController';
    public static $inject:Array<any> = ['$rootScope', '$scope', '$mdToast', '$mdDialog', 'Restangular', '$http', '$q'];

    public title:string = 'Schema列表';
